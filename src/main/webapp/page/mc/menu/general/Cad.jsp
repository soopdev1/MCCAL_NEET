...
<li class="kt-menu__item <%=cad%>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
    ...
    <div class="kt-menu__submenu">
        ...
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item <%=pageName.equals("addCpiUser.jsp") ? "kt-menu__item--active" : ""%>" aria-haspopup="true">
                <a href="addCpiUser.jsp" class="kt-menu__link ">
                    <i class="kt-menu__link-bullet fa fa-user-plus">
                        <span></span>
                    </i>
                    <span class="kt-menu__link-text">Crea Utente CPI</span>
                </a>
            </li>
            <li class="kt-menu__item <%=pageName.equals("cpiUser.jsp") ? "kt-menu__item--active" : ""%>" aria-haspopup="true">
                <a href="cpiUser.jsp" class="kt-menu__link ">
                    <i class="kt-menu__link-bullet fa fa-list">
                        <span></span>
                    </i>
                    <span class="kt-menu__link-text">Utenti CPI</span>
                </a>
            </li>
