                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="kt-portlet" id="kt_portlet" data-ktportlet="true"><!--io-background-->
                                        ...
                                        <form id="kt_form" action="<%=request.getContextPath()%>/OperazioniMicro?type=addActivity" class="kt-form kt-form--label-right" accept-charset="ISO-8859-1" method="post">
                                            <div class="kt-portlet__body paddig_0_t paddig_0_b">
                                                <div class="kt-section kt-section--first">
                                                    <div class="kt-section__body"><br>
                                                        <div class="form-group row">
                                                            <div class="col-lg-8">
                                                                <label>Nome Attività</label><label class="kt-font-danger kt-font-boldest">*</label>
                ...
                if (ctrlForm()) {
                    ...
                    $('#kt_form').ajaxSubmit({
                        ...
                        success: function (resp) {
                            ...
                            if (json.result) {
                                resetInput();
                                swalSuccess("Attività aggiunta!", "Operazione effettuata con successo.");
                            } else {
